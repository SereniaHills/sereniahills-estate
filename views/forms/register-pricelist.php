<section id="booking" class="bg-white pt-4 pb-4">
    <div class="container position-relative">
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                <h1 class="mb-3 titlecontent text-light-blue fw-bold">Request Pricelist</h1>
                <h6 class="mb-3 text-dark title-map-form lh-base">Complete the form below and a member of our sales and
                    marketing team shall contact you with the details of your appointment or enquiry.</h6>
                <form action="#" id="form-booking" name="requestBookingViewMaps" class="form-all php-email-form">
                    <div class="row">
                        <div class="form-group mt-3">
                            <input type="text" name="name" class="form-control rounded-0 f-20" id="name"
                                placeholder="Full Name*" required>
                        </div>
                        <div class="form-group mt-3">
                            <input type="email" class="form-control rounded-0 f-20" name="email" id="email"
                                placeholder="Email Address*" required>
                        </div>
                        <div class="form-group mt-3">
                            <input type="tel" class="form-control rounded-0 f-20" name="phone" id="phone"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <button type="submit" value="Request Pricelist" id="btnRequestPricelist"
                                class="w-100 b-white border-button learn-more">
                            ...
                            <a href="/thankyouPage" class="btn btn-get b-bluedark learn-more f-25 c-white">Get
                                Brochure</a>
                        </div>
                    </div>
                </form>
